...
// writeHealthFile stages a health report under SYNAPSE_HOME at the path
...
// ~/.synapse/logs and the FindLogFile glob fallback points at the wrong
// place.
...
// stage a health report + agent log under SYNAPSE_HOME, run the CLI, and
...
// the ledger subcommand relies on, without touching any real ~/.synapse.
