...
func buildAllowances() map[allowanceKey]allowance { //nolint:funlen // The explicit exception ledger is intentionally centralized for review.
	...
	add(kindProvider, "internal/llmexec/llmexec_test.go", "Test fixture intentionally spells provider wire values to verify parsing, routing, or compatibility.", map[string]int{"claude": 6, "codex": 20, "copilot": 9, "opencode": 6})
	...
	add(kindTaskStatus, "internal/sybra/svc_tasks_cluster_push_test.go", "Test fixture intentionally spells persisted task-status wire values to verify workflow or compatibility.", map[string]int{"done": 2})
	...
	add(kindTaskStatus, "internal/workflow/engine_steps_verify_checks_test.go", "Test fixture intentionally spells persisted task-status wire values to verify workflow or compatibility.", map[string]int{"blocked": 3, "human-required": 5, "in-progress": 39})
