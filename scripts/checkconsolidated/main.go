...
func buildAllowances() map[allowanceKey]allowance { //nolint:funlen // The explicit exception ledger is intentionally centralized for review.
	...
	add(kindTaskStatus, "internal/workflow/engine_plan_test.go", "Test fixture intentionally spells persisted task-status wire values to verify workflow or compatibility.", map[string]int{"human-required": 8, "in-progress": 5, "plan-review": 3, "planning": 21, "todo": 4})
