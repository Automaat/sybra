...
func TestBuiltinTestingTask_RunTestOutputSchema(t *testing.T) {
	...
	const wantSchema = `{"type":"object","properties":{"verdict":{"type":"string","enum":["PASS","FAIL"]},"outcome":{"type":"string","enum":["pass","product_bug","infra_failure","ambiguous_requirement","missing_evidence"]},"failures_markdown":{"type":"string"},"surface_kind":{"type":"string"},"app_started":{"type":"boolean"},"start_command":{"type":"string"},"readiness_probe":{"anyOf":[{"type":"string"},{"type":"object","properties":{"command":{"type":"string"},"expected":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]},"actual":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]},"observed":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]},"output":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]},"status":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]},"url":{"type":"string"}},"required":["command","expected","actual","observed","output","status","url"],"additionalProperties":false}]},"manual_probes":{"type":"array","items":{"anyOf":[{"type":"string"},{"type":"object","properties":{"command":{"type":"string"},"expected":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]},"actual":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]},"observed":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]},"output":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]},"status":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]}},"required":["command","expected","actual","observed","output","status"],"additionalProperties":false}]}},"automated_checks":{"type":"array","items":{"anyOf":[{"type":"string"},{"type":"object","properties":{"command":{"type":"string"},"actual":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]},"observed":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]},"output":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]},"status":{"anyOf":[{"type":"string"},{"type":"number"},{"type":"boolean"}]}},"required":["command","actual","observed","output","status"],"additionalProperties":false}]}},"unable_to_run_reason":{"type":"string"}},"required":["verdict","outcome","failures_markdown","surface_kind","app_started","start_command","readiness_probe","manual_probes","automated_checks","unable_to_run_reason"],"additionalProperties":false}`
