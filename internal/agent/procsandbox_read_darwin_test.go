...
func TestWrapInvocation_GrantsAllGitRoots(t *testing.T) {
	spec := sandboxSpec{
		...
		gitLooseObjectPattern:       `^/data/clones/repo\.git/objects/(tmp_obj_[^/]+|[0-9a-f][0-9a-f]/[^/]+)$`,
		gitLooseObjectFanoutPattern: `^/data/clones/repo\.git/objects/[0-9a-f][0-9a-f]/[0-9a-f]+$`,
