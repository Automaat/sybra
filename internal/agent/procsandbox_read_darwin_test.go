...
func TestWrapInvocation_GrantsAllGitRoots(t *testing.T) {
	spec := sandboxSpec{
		...
		gitLooseObjectPattern:       `^/data/clones/repo\.git/objects/(tmp_obj_[^/]+|[0-9a-f][0-9a-f]/(tmp_obj_[^/]+|[0-9a-f]{38}|[0-9a-f]{62}))$`,
		gitLooseObjectFanoutPattern: `^/data/clones/repo\.git/objects/[0-9a-f][0-9a-f]/([0-9a-f]{38}|[0-9a-f]{62})$`,
		...
		gitRemoteLogLockPattern:     `^/data/clones/repo\.git/logs/refs/remotes/.*\.lock$`,
		gitTagRefDir:                "/data/clones/repo.git/refs/tags",
		gitTagLogDir:                "/data/clones/repo.git/logs/refs/tags",
		gitTagLogLockPattern:        `^/data/clones/repo\.git/logs/refs/tags/.*\.lock$`,
		gitNotesRefDir:              "/data/clones/repo.git/refs/notes",
		gitNotesLogDir:              "/data/clones/repo.git/logs/refs/notes",
		gitNotesLogLockPattern:      `^/data/clones/repo\.git/logs/refs/notes/.*\.lock$`,
	}
	...
	want := map[string]string{
		...
		"GIT_LOOSE_OBJECT_PATTERN":        spec.gitLooseObjectPattern,
		"GIT_LOOSE_OBJECT_FANOUT_PATTERN": spec.gitLooseObjectFanoutPattern,
		...
		"GIT_REMOTE_LOG_LOCK_PATTERN":     spec.gitRemoteLogLockPattern,
		"GIT_TAG_REF_DIR":                 spec.gitTagRefDir,
		"GIT_TAG_LOG_DIR":                 spec.gitTagLogDir,
		"GIT_TAG_LOG_LOCK_PATTERN":        spec.gitTagLogLockPattern,
		"GIT_NOTES_REF_DIR":               spec.gitNotesRefDir,
		"GIT_NOTES_LOG_DIR":               spec.gitNotesLogDir,
		"GIT_NOTES_LOG_LOCK_PATTERN":      spec.gitNotesLogLockPattern,
	}
...
func TestSandboxProfile_ReferencesAllGitRoots(t *testing.T) {
	...
	for _, rule := range []string{
		...
		`(regex (param "GIT_LOOSE_OBJECT_FANOUT_PATTERN"))`,
