...
- mode: always "headless" — interactive mode is being phased out and should never be emitted
...
- Always emit "headless". Interactive mode is going away — do not pick it
  regardless of how ambiguous, architectural, or complex the task looks.
