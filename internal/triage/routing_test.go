...
func TestRouteStatus(t *testing.T) {
	tests := []struct {
		...
		{"work small bug", "small", "bug", "work", task.StatusPlanning},
		{"work small feature", "small", "feature", "work", task.StatusPlanning},
		{"work small refactor", "small", "refactor", "work", task.StatusPlanning},
		{"work docs", "small", "docs", "work", task.StatusPlanning},
		{"work chore", "small", "chore", "work", task.StatusPlanning},
		{"work review", "medium", "review", "work", task.StatusTodo},
		{"review any size", "medium", "review", "", task.StatusTodo},
		{"pet medium bug", "medium", "bug", "pet", task.StatusTodo},
