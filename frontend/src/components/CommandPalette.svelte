    ...
    >
      <div class="flex items-center border-b border-surface-300 px-4 dark:border-surface-600">
        ...
        <input
          ...
          class="flex-1 bg-transparent py-3 pl-3 text-sm outline-none placeholder:text-surface-400"
        />
        <kbd class="rounded bg-surface-200 px-1.5 py-0.5 font-mono text-xs text-surface-400 dark:bg-surface-700">Esc</kbd>
      </div>
        ...
        {:else}
          {#each results as result, i}
            <li>
              <button
                type="button"
                class="flex w-full items-center gap-3 px-4 py-2.5 text-left text-sm transition-colors {i === selectedIndex ? 'bg-primary-100 text-primary-800 dark:bg-primary-900/40 dark:text-primary-200' : 'hover:bg-surface-200 dark:hover:bg-surface-700'}"
      ...
      <div class="border-t border-surface-300 px-4 py-2 dark:border-surface-600">
