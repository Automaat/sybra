...
export const EvaluationReport = "evaluation:report"
...
export const BgOpStarted = "bgop:started"
export const BgOpProgress = "bgop:progress"
export const BgOpCompleted = "bgop:completed"
export const BgOpFailed = "bgop:failed"
