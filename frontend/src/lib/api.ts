...
import * as AgentSvc from '../../wailsjs/go/synapse/AgentService.js'
import * as AppSvc from '../../wailsjs/go/synapse/App.js'
import * as ConfigSvc from '../../wailsjs/go/synapse/ConfigService.js'
import * as IntegrationSvc from '../../wailsjs/go/synapse/IntegrationService.js'
import * as LoopSvc from '../../wailsjs/go/synapse/LoopAgentService.js'
import * as OrchestratorSvc from '../../wailsjs/go/synapse/OrchestratorService.js'
import * as PlanningSvc from '../../wailsjs/go/synapse/PlanningService.js'
import * as ProjectSvc from '../../wailsjs/go/synapse/ProjectService.js'
...
// App
export const GetMonitorHeartbeat = pick(AppSvc.GetMonitorHeartbeat, http.GetMonitorHeartbeat)
