...
export const GetAutonomyTrend = pick(AppSvc.GetAutonomyTrend, http.GetAutonomyTrend)
...
export const ListAttachments = pick(TaskSvc.ListAttachments, http.ListAttachments)
...
export const UploadAttachment = pick(TaskSvc.UploadAttachment, http.UploadAttachment)
